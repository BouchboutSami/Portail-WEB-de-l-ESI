...
import Breadcrumb from "./Braedcrum";
...
const PageImg = (props) => {
  return (
    <div className="w-full h-[500px] relative pl-[5%]">
      ...
      <div className="absolute bottom-8 w-full font-poppins font-medium text-white ">
        <div className="flex flex-col">
          <h1 className="text-[48px] font-extrabold text-white">
            {props.titre}
          </h1>
          <p className="text-[16px] font-medium text-white w-[600px]">
            {props.details}
          </p>
        </div>
      </div>
