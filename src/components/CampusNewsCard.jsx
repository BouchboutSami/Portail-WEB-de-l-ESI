...
const CampusNewsCard = (props) => {
  ...
  return (
    ...
    >
      ...
      {Shadow && (
        <>
          <div className="absolute bottom-0 left-0 w-full opacity-90 h-40 bg-gradient-to-t from-[#0E375F] " />
          <div className="absolute bottom-8 left-0 w-full font-poppins font-medium text-white  text-[12px]">
