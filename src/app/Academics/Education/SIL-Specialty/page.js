...
export default function Home() {
  ...
  const conditions =
    "To pass the requirements of the common core in the second cycle, candidates must obtain an average mark equal to or greater than 10 and must not receive any eliminatory mark. In addition, admission is subject to taking into account the candidate's ranking within the promotion.";
  const objectives = [
