...
import NavBar from "../../../Components/NavBar";import NextEvents from "@/components/LandingPage/NextEvents";
      ...
      <div className=" w-screen">
        ...
        <div className="flex w-full">
            <div className="w-full flex flex-col bg-[#F5F5F5] justify-center items-center min-h-max xl:px-[15%] lg:px-[15%] px-[10%]">
                <h1 className="text-noir font-bold text-4xl m-5">Upcoming Events</h1>
                <NextEvents />
            </div>
        </div>
        <div className="w-3/5 flex flex-col items-center mb-4 mt-4 gap-10">
            <h1 className="text-center font-bold text-4xl mb-4 mt-4" >Discover ESI's major events </h1>
            <EventDiscoverArtcile imageUrl={"/assets/campus4.jpg"} title={"Journée portes ouvertes"} description={"Every year, ESI opens its doors at the beginning of the year to baccalaureate students to find out about the courses on offer, ask questions, talk to students and teachers at the school and find out more about life at ESI."}/>
