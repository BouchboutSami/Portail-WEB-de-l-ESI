                ...
                <div className="flex">
                    ...
                    <div className="w-full flex flex-col items-center pb-12">
                        ...
                        <div className="w-full my-12 items-center px-[5%]">
                            ...
                            <ListComp heading={""} paragraph={"Its main missions are:"} points={LibPoints} />
                            ...
                            <p className="font-poppins font-light text-[18px]">The library is arranged on three levels:</p>
                            <div className="font-poppins font-light text-[18px]">
                                <ul className="list-disc pl-5">
                                    <li>
                                        Basement
                                        <ul className="list-disc pl-5">
                                            <li>Museum of the Library bringing together resources (documents, materials, software) relating to the history of computing.</li>
                                            <li>Part of the documentary fund (old versions and editions).</li>
                                        </ul>
                                    </li>
                                    <li>
                                        Ground floor
                                        <ul className="list-disc pl-5">
                                            <li>A large reading room for students, accommodating 160 students.</li>
                                    ...
                                    <li>
                                        ...
                                        <ul className="list-disc pl-5">
                                            ...
                                            <li>A counter dedicated to the lending and return of books.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="px-[5%] pt-[2%] flex flex-row gap-[10%]">
                            ...
                            <h3 className="font-poppins font-bold text-[20px]">Every year, the library organizes:</h3>
                            <h1 className="font-poppins font-bold text-[22px] text-[#185B9C] mt-8">
                                In April
                            </h1>
                            <p className="font-poppins font-light text-[18px]">
                                An information day for the preparation of the technical sheet (Purchase Order), concerning new books, is organized, its objective is to collect the needs of students and teachers.
                            </p>
                            <h1 className="font-poppins font-bold text-[22px] text-[#185B9C] mt-8">
                                In May
                            </h1>
                            <p className="font-poppins font-light text-[18px]">
                                Open days related to the new acquisitions of books, the objective is the dissemination of information (duration 3 to 4 days) regarding the newly acquired books.
                            </p>
                            </div>
