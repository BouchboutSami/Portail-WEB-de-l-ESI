...
const Academics = () => {
  ...
  return (
    <div className="w-full bg-[#F5F5F5] p-4">
      <div className='text-black font-bold font-poppins text-[36px] text-center'>Academics</div>
      <div className='text-black font-medium font-poppins text-[20px] text-center mb-4'>Have a look at the program studies that ESI offers</div>
