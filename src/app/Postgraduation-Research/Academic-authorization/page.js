...
const page = () => {
  const News = [
    ...
    },
    {
      image: "/assets/HabilitationAUF.png",
      title:
        "2ème Assise de la francophonie scientifique",
      link: "/",
    },
    {
      image: "/assets/HabilitationAUF.png",
  ...
  return (
    ...
    <BrowserRouter>
      <div className=" w-screen">
        <NavBar />
        <PostImage image="/assets/ResearchProjects.png"
        ...
        <div className="flex ">
          ...
          Understanding accreditation not only sheds light on the credibility and 
          legitimacy of educational offerings but also illuminates the broader landscape of 
          academia and its continuous pursuit of improvement.
          </div>
          <div className="w-full flex justify-center items-center flex-col">
            <p className="text-black font-poppins font-bold text-[20px] mb-4">University accreditation</p>
            <div className="flex justify-center items-center gap-5">
              <CampusNewsCard title="Annonces" image="/assets/HabilitationAnnonce.png"/>
              <CampusNewsCard title="Guide" image="/assets/HabilitationGuide.png"/>
              <CampusNewsCard title="Documents"image="/assets/HabilitationDocs.png" />
            </div>
         </div>

         <div className="bg-[#F5F5F5] w-full px-[5%] mt-4">
         <p className="text-black font-poppins font-bold text-[20px] mb-4">Articles News </p>
