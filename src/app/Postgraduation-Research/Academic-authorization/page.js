        ...
        <div className="flex ">
          ...
          <div className=" w-full items-center text-center">
            <div className="text-black font-poppins text-[20px] mt-6 px-8 py-8">
              Understanding accreditation not only sheds light on the
              credibility and legitimacy of educational offerings but also
              illuminates the broader landscape of academia and its continuous
