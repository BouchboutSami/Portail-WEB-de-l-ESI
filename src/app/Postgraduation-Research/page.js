        ...
        <div className="flex w-full justify-center pt-8 text-center text-[16px] font-poppins">
          <div className="flex flex-col gap-8 w-full items-center">
            <p className="w-[900px] mx-8">
              We provide an environment dedicated to nurturing the academic and
              research endeavors of our individuals. We empower them to explore
              their passions, push boundaries, and contribute to the forefront
